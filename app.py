...
def dashboard():
    ...
    try:
        with conn.cursor() as cursor:
            ...
            cursor.execute("SELECT DISTINCT manager_nickname FROM sanction_logs WHERE manager_nickname IS NOT NULL AND manager_nickname != ''")
    ...
    return render_template("dashboard.html", logs=logs, total_stats=total_stats, managers=managers, selected_manager=selected_manager)
